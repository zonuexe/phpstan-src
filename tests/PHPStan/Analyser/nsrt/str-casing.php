...
class Foo {
	...
	public function bar($numericS, $nonE, $lowercaseS, $literal, $edgeUnion, $caseMode, $kanaMode, $mixed) {
		...
		assertType("numeric-string&uppercase-string", strtoupper($numericS));
		assertType("lowercase-string&numeric-string", mb_strtolower($numericS));
		assertType("numeric-string&uppercase-string", mb_strtoupper($numericS));
		...
		assertType("numeric-string&uppercase-string", mb_convert_case($numericS, MB_CASE_UPPER));
		...
		assertType("non-empty-string&uppercase-string", strtoupper($nonE));
		assertType("lowercase-string&non-empty-string", mb_strtolower($nonE));
		assertType("non-empty-string&uppercase-string", mb_strtoupper($nonE));
		assertType("non-empty-string", lcfirst($nonE));
		assertType("non-empty-string", ucfirst($nonE));
		assertType("non-empty-string", ucwords($nonE));
		assertType("non-empty-string&uppercase-string", mb_convert_case($nonE, MB_CASE_UPPER));
		...
		assertType("uppercase-string", mb_strtoupper($literal));
		assertType("string", lcfirst($literal));
		assertType("string", ucfirst($literal));
		assertType("string", ucwords($literal));
		assertType("uppercase-string", mb_convert_case($literal, MB_CASE_UPPER));
